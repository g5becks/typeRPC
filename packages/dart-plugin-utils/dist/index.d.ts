...
export declare const requestClassName: (svcName: string, methodName: string, schema: Schema) => string;
export declare const responseClassName: (svcName: string, methodName: string, schema: Schema) => string;
export declare const buildTypes: (schema: Schema) => string;
export declare const buildAbstractClass: (svc: QueryService | MutationService, schema: Schema) => string;
