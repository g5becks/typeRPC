...
export declare const requestClassName: (svcName: string, methodName: string) => string;
export declare const responseClassName: (svcName: string, methodName: string) => string;
