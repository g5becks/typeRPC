import { HTTPErrCode, HTTPResponseCode } from '../../schema/lib/schema'
...
import { parseQueryServices, parseServiceMethods } from '../../parser/lib/parser'
...
const validateReturnType = (method: MethodSignature): Error[] =>
    isValidDataType(method.getReturnTypeNode())
        ? []
        : [
              singleValidationErr(
                  method,
