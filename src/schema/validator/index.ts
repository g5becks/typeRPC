...
import {isContainer, isHttpVerb, isMsg, isMsgLiteral, isQuerySvc, isValidDataType} from './utils'
...
export {isMsg, isMsgLiteral, isQuerySvc, isContainer, isHttpVerb,  isValidDataType, isErrCode, isResponseCode}
