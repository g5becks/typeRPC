...
import {genImports, useCbor} from '.'
...
const genMutationSvcParamType = (msgNames: string[]) => {
  const generated = [genRandomDataType(msgNames), genRpcMsgLiteral(msgNames), genRandomDataType(msgNames), genRandomDataType(msgNames)]
  return generated[randomNumber(0, generated.length)]
}
// gen a method param
...
const genReturnType = (msgNames: string[]): string => {
  const generated = [genRandomDataType(msgNames), genRandomDataType(msgNames), genRandomDataType(msgNames), genRpcMsgLiteral(msgNames)]
  return generated[randomNumber(0, generated.length)]
}
